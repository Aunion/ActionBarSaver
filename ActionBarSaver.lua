...
SlashCmdList["ABS"] = function(msg)
	...
	-- Halp
		...
		DEFAULT_CHAT_FRAME:AddMessage("|cff33ff99/abs save <" .. L["profile"] .. ">|r - " .. L["Saves your current action bar setup to the specified profile."])
		DEFAULT_CHAT_FRAME:AddMessage("|cff33ff99/abs restore <" .. L["profile"] .. ">|r - " .. L["Restores your action bars to the specified profile."])
		DEFAULT_CHAT_FRAME:AddMessage("|cff33ff99/abs softrestore <" .. L["profile"] .. ">|r - " .. L["Restores your action bars to the specified profile. Soft restore will only add saved buttons, not empty buttons that have no value saved to them."])
		DEFAULT_CHAT_FRAME:AddMessage("|cff33ff99/abs delete <" .. L["profile"] .. ">|r - " .. L["Deletes the specified profile."])
		...
		DEFAULT_CHAT_FRAME:AddMessage("|cff33ff99/abs macro|r - " .. L["Toggle whether to attempt to restore any macros that don't exist or have been deleted when restoring a profile. Off by default."])
		...
		DEFAULT_CHAT_FRAME:AddMessage(L["Linked sets allow you to add several abilities to a list of linked abilities, and if one of those abilities is listed in a profile but not available to your character, it will try to find another one from that list."])
