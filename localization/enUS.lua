...
L["Toggle whether to attempt to restore any macros that don't exist or have been deleted when restoring a profile. Off by default."] = "Toggle whether to attempt to restore any macros that don't exist or have been deleted when restoring a profile. Off by default."
...
L["Restores your action bars to the specified profile."] = "Restores your action bars to the specified profile."
...
L["Deletes the specified profile."] = "Deletes the specified profile."
L["DRUID"] = "Druid"
...
L["Saves your current action bar setup to the specified profile."] = "Saves your current action bar setup to the specified profile."
L["SHAMAN"] = "Shaman"
